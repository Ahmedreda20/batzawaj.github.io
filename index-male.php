    ...
    <div class="container">
        <div class="row d-flex mt-5 align-items-center mb-img-txt">
            <div class="col-lg-8 col-md-12  text-right mb-order-above">
                <h1 class="title" >اختبار شخصيات الأزواج</h1>
        ...
        <div class="row">
            <div class="col-lg-8  qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">1.</span>	إذا بتسافر سفرة مع زوجتك، وين بتروحون؟</h2>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="radio-item">
                            <input type="radio" id="ritema" name="ritem1" value="a3" required>
                            <label for="ritema">أي مكان رومانسي أهم شي ما تفارق عيوني. </label>
                        </div>
                        <div class="radio-item">
        ...
        <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">2.</span>	إنت وزوجتك ساكتين طول القعدة، شنو شعورك؟</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="radio-item">
                            <input type="radio" id="ritem1" name="ritem2" value="a5" required>
                            <label for="ritem1">الهدية الغالية اللي بإيدها اتحجي، فمو مهم. </label>
                        </div>
                        <div class="radio-item">
                        ...
                        <div class="radio-item">
                            ...
                            <label for="ritem3">أظن إنها يوعانة مثلي. </label>
                        </div>
                        <div class="radio-item">
        ...
        <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">3.</span>	هل راح تستمتع بالويكند بروحك بدون زوجتك؟</h2>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="radio-item">
                            <input type="radio" id="ritem5" name="ritem3" value="a5" required>
                            <label for="ritem5">راح أزعل عشان تشتري لي حبيبتي شي تراضيني فيه. </label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" id="ritem6" name="ritem3" value="a6" required>
                            <label for="ritem6">راح أستمتع بالوقت بروحي، لأن بهذا الوقت راح أصير على طبيعتي. </label>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="radio-item">
...
<!-- forth -->
       <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">4.</span>	شنو أحلى هدية ممكن توصل لك من زوجتك؟</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="radio-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="radio-item">
                            ...
                            <label for="ritem15">وناستها من وناستي. </label>
                        </div>
                        <div class="radio-item">
...
<!-- sixth -->
        <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">6.</span>.	هل تاخذ راي زوجتك في مظهرك؟</h2>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="radio-item">
                            <input type="radio" id="ritem17" name="ritem6" value="a5" required>
                            <label for="ritem17">صرفت وايد على هالتزقرت، على الأقل تقدّر بكلمتين حلوين. </label>
                        </div>
                        <div class="radio-item">
...
<!-- seventh -->
        <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">7.</span>	شنو من هالأشياء الأكثر رومانسية ممكن تسويه؟</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="radio-item">
                        ...
                        <div class="radio-item">
                            ...
                            <label for="ritem22">أهدي لها اشتراك نتفلكس مدى الحياة. </label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" id="ritem23" name="ritem7" value="a3" required>
                            <label for="ritem23">أراضيها ببوكيه ورد عن شي ضايقتها فيه. </label>
                        </div>
                        <div class="radio-item">
...
<!-- eighth -->
        <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">8.</span>	زوجتك ترقت لمنصب كبير، شنو الشي اللي ممكن تكافئها فيه؟</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="radio-item">
                            <input type="radio" id="ritem25" name="ritem8" value="a5" required>
                            <label for="ritem25">حفلة على شرفها وسيارة يديدة مع ساعة وسفرة أسبوع. </label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" id="ritem26" name="ritem8" value="a6" required>
                            <label for="ritem26">بوكيه ورد يوصل لمكتبها. </label>
                        </div>
                        <div class="radio-item">
                        ...
                        <div class="radio-item">
                            ...
                            <label for="ritem28">أهديها لعبة نينتندو ليمتد ايديشن. </label>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- nineth -->
        <div class="row mt-3">
            <div class="col-lg-8 qa">
                <div>
                    <h2 class="q-title" dir="rtl"><span class="title_num">9.</span>	لما تتصل عليك زوجتك وقت الدوام عن شنو بيكون الاتصال؟</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="radio-item">
                            <input type="radio" id="ritem29" name="ritem9" value="a3" required>
                            <label for="ritem29">سالفة عن الموظفين بالدوام وشكثر دوامها يغث. </label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" id="ritem30" name="ritem9" value="a4" required>
                            <label for="ritem30">شكثر وصلت الفيوز ملوتها بتيك توك. </label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" id="ritem31" name="ritem9" value="a5" required>
                            <label for="ritem31">موعدنا بالسبا. </label>
                        </div>
                        <div class="radio-item">
